# -*- coding: utf-8 -*-
"""
Created on Mon Aug 17 01:21:51 2020
...
# =============================================================================
# code of problem-1 for problem 4
# =============================================================================
...
ans = final_df[final_df['Rank'] == 4]['2015'] - final_df[final_df['Rank'] == 4]['2006']
print(pd.to_numeric(ans)[0])
...
six = final_df.iloc[3,19] - final_df.iloc[3,10]
print(six)
